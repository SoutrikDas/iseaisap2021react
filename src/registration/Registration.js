    ...
    return ( 
        <div>
            ...
            <div className="m-1 m-md-5 p-1 p-md-5 shadow bg-body rounded">
                <h2 className="display-6 mt-2 mb-5">Registration Fees</h2>
                ...
                <h2 className="display-6 mt-5 mb-5">Registration Guidelines</h2>
                <ol class="list-group list-group-numbered my-3 custom-font  ">
                <li class="list-group-item list-group-item-action list-group-item-dark">At least one of the authors of
                ...
                <li class="list-group-item list-group-item-action"> Each author registration covers up to two papers for
                    the same set of authors.</li>

                <li class="list-group-item list-group-item-action list-group-item-dark">Additional authors (other than
                    those who are included in the manuscript submitted for review) cannot be added to the camera ready
                    paper.</li>

                <li class="list-group-item list-group-item-action">All participants need to be register to attend the
                    ISEA-ISAP 2021 by paying the requisite registration fees.</li>

                <li class="list-group-item list-group-item-action list-group-item-dark">Authors claiming subsidized
                ...
                <li class="list-group-item list-group-item-action"> The registration fees include the conference kit,
                ...
                <li class="list-group-item list-group-item-action list-group-item-dark"> Authors have to complete the
            ...
            <h2 className="display-6 mt-5 mb-5">Registration Details</h2>
