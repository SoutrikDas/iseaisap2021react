                ...
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                  <div className="container-fluid ">
                    ...
                    <a className="navbar-brand " href="#"> 
                      <img className="img-fluid flex-column" style={{maxWidth: '10%', height: 'auto'}} src={iitismlogo} alt="" />
                      IIT ISM Dhanbad
                    </a>
                      ...
                      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item dropdown">
                          ...
                          <ul className="dropdown-menu " aria-labelledby="navbarDropdown">
                            ...
                            <li><Link className="dropdown-item" to="/authors/tutorial">Call for Tutorials</Link></li>
                        ...
                        <li className="nav-item dropdown">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><Link className="dropdown-item" to="/registration/hotel">Hotel Registration</Link></li>
                          </ul>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item dropdown">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><Link className="dropdown-item" to="/committee/social">Social Committe</Link></li>
                          </ul>
                        </li>
                      </ul>
                    </div>
